...
/****This component handles Office houses */
...
function Office() {
  ...
  const ezyStayProperties = properties.filter(
    (property) => property?.propertyCategory === "office"
  );
...
// This code is a React component that displays a list of properties filtered by the "Office" category. It uses the PropertyContext to fetch and manage property data, and includes a header and a WhatsApp component for user interaction.
