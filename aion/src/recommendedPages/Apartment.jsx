...
/****This component handles Apartment houses */
...
function Apartment() {
  ...
  const ezyStayProperties = properties.filter(
    (property) => property?.propertyCategory === "apartment"
  );
...
// This code is a React component that displays a list of properties filtered by the "ezy-stay" category. It uses the PropertyContext to fetch and manage property data, and includes a header and a WhatsApp component for user interaction.
